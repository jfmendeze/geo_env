...
# --------------------------------------------------------------------------
    ...
    def dynamic(self):
        ...
        #Added by TT - used for KAUST - climate change sensitivity analysis
        ...
        # Added by TT - used for KAUST - Climate sensitivity analysis
        # Note that the operation is done on temperature in degrees C
